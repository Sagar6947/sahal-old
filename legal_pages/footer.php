...
Review Kiya Helps You To Get A Digital Impression Via Generating Your Company VCard Along With Your Employees VCard Here That Is Smart & Elegant.</p>
						...
						<div class="col-md-3 col-sm-6">
							<div class="footer-widget">
								...
								<ul class="footer-navigation sinlge">
									<li><a href="about-SaharDirectory.php">About Us</a></li>
									<li><a href="blog-SaharDirectory.php">Blogs</a></li>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form method="POST" action="<?= website_url ?>company/login.php">
								...
								<div class="center">
									<input  type="submit" class="btn btn-midium theme-btn btn-radius width-200" 
									name="vbsubmit" />
								</div>
