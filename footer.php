					...
					<div class="row">
						 ...
						 <div class="col-md-3 col-sm-6">
							<div class="footer-widget">
								...
								<p>Digital Impression, The First Impression Sahar Directory Helps You To Get A Digital Impression Via Generating Your Company VCard Along With Your Employees VCard Here That Is Smart & Elegant.</p>
						...
						<div class="col-md-3 col-sm-6">
							<div class="footer-widget">
								...
								<ul class="footer-navigation sinlge">
									...
									<li><a href="legal_pages/disclaimer.php">Disclaimer</a></li>
									<li><a href="legal_pages/privacy_policy.php">Privacy Policy</a></li>
									<li><a href="legal_pages/refund_policy.php">Refund Policy</a></li>
									<li><a href="legal_pages/terms&condition.php">Terms & Condition </a></li>
								</ul>
							</div>
						</div>
						...
						<div class="col-md-3 col-sm-6">
							<div class="footer-widget">
								...
								<ul class="footer-navigation sinlge">
									<li><a href="legal_pages/about-SaharDirectory.php">About Us</a></li>
									<li><a href="legal_pages/blog-SaharDirectory.php">Blogs</a></li>
									<li><a href="company/company-packages.php">Prices</a></li>
									<li><a href="company/add-company.php">Create vCard</a></li>
