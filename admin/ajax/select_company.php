...
while ($select_company_row = $select_company->fetch_assoc()) {
  ...
  $output .= '     <tr>
                            ...
                            ' .     (($select_company_row["company_type"] == 0)? $select_company_row["company_name"] :  $select_company_row["company_person"])   .'
                                ...
                                <p>Username: ' . $select_company_row["company_contact"] . '<br>Password : ' . $select_company_row["company_password"] . '</p></td>
  ...
  $output .= '  <td>' . $select_company_row["created_date"] . '</td>
                                ...
                                <td><a href="ajax/company-del.php?id=' . $select_company_row["company_id"] . '" class="btn btn-primary">Delete</td>
