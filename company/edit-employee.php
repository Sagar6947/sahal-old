						...
						<div class="add-listing-box general-info mrg-bot-25 padd-bot-30 padd-top-25">
							...
							<form method="post" action="edit-employee-code.php" enctype="multipart/form-data"> 
								<div class="row mrg-r-10 mrg-l-10">
								      ...
								      <input type="hidden" maxlength="255" class="form-control" placeholder="Employee Name"  id="employee_name" name="emp_id" value="<?php if(isset($_GET['id'])){
								  echo ' $_GET["id"] ';    } else if(isset($employee)){ echo '$employee';  } else{ echo '<script>window.location="../index.php"</script>'; } ?>" />
								  
								  <input type="hidden" maxlength="255" class="form-control"  name="com_id" value="<?= $emp['company_id']; ?>" />
									<div class="col-sm-4">
